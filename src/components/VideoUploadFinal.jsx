...
import { Upload, FileVideo, AlertCircle, Sparkles, Target, Link, ShoppingCart } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
import { Textarea } from '@/components/ui/textarea';

const VideoUploadFinal = ({ onUploadComplete, isProcessing }) => {
  ...
  const detectPlatform = (url) => {
    ...
    if (url.includes('mercadolivre.com') || url.includes('mercadolibre.com')) return 'Mercado Livre';
    if (url.includes('amazon.com')) return 'Amazon';
    if (url.includes('aliexpress.com')) return 'AliExpress';
    if (url.includes('hotmart.com')) return 'Hotmart';
    if (url.includes('eduzz.com')) return 'Eduzz';
    ...
    <div className="w-full max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700">
              1. Informe o tema e link do produto<br/>
              2. Faça upload do seu vídeo<br/>
              3. Nossa IA analisa tudo automaticamente<br/>
              4. Receba conteúdo viral pronto para usar
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            id="productLink"
            placeholder="https://shopee.com.br/produto... ou https://mercadolivre.com.br/produto..."
            value={productLink}
        ...
        {productLink && (
          <div className="flex items-center gap-2 text-sm text-green-600">
            ...
            Plataforma detectada: {detectPlatform(productLink)}
          </div>
        )}
        <p className="text-xs text-gray-600">
          Adicione o link para gerar descrições mais específicas e persuasivas
        </p>
      </div>
      ...
      >
        {isProcessing ? (
          ...
          <div className="flex items-center gap-2">
            ...
            Processar Vídeo e Gerar Conteúdo Viral
          </div>
        )}
      </Button>
        ...
        {productLink && (
          <div className="mt-3 p-2 bg-blue-50 rounded border-l-4 border-blue-400">
            <p className="text-xs text-blue-700">
              <strong>Com link do produto:</strong> Descrições mais persuasivas, CTAs direcionados e maior taxa de conversão!
            </p>
          </div>
        )}
      </div>
